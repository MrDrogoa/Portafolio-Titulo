    ...
    <header>
        ...
        <nav class="font-[Montserrat]">
            <section
                ...
                <div
                    id="menu-content"
                    class="lg:flex hidden flex-grow justify-between items-center absolute lg:relative lg:top-0 top-24 left-0 w-full lg:w-auto bg-white lg:bg-transparent py-10 px-8 lg:py-0 lg:px-0 z-30">
                    <?php wp_nav_menu(
                        array(
